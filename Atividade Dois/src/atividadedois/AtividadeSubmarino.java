//Lucas Negresiolo Libório - 17.01165-5
...
public class AtividadeSubmarino {
    ...
    public static ListaDeDesejos listaDeDesejos;

    public static void main(String[] args) {
        loja = new Loja();
        sc1 = new Scanner(System.in);
        carrinho = new Carrinho();
        listaDeDesejos = new ListaDeDesejos();
        menuInicial();
    }
    ...
    static public void finalizarPedido(){
        ...
        System.out.println(pedido.resumoPedido(carrinho) );
    ...
    static public void menuDepartamento(Produto.departamento depTemp){
        ...
        do{
            ...
            Produto prod[] = loja.listaPorDepartamento(depTemp);
            String sTemp = "";
        ...
        do {
            ...
            switch (op){
                case 1:
                    ...
                    break;
                case 2:
                    b = listaDeDesejos.adicionarALista(loja.produtos[indexProd]);
                    if (b){
                        System.out.println("Produto adicionado a lista de desejos com sucesso.");
                        System.out.println("Você possui +" + listaDeDesejos.getRestantes() + " lugares na lista\n\r");
                    } else {
    ...
    static public void menuDesejos(){
        ...
        do {
            ...
            System.out.println(listaDeDesejos.retornarResumo());
            System.out.println("--------------------");
            ...
            switch (op){
                case 1:
                    b = listaDeDesejos.removerUltimoDaLista();
                    if (b){
                        System.out.println("Produto removido.");
                        System.out.println("Você possui +" + carrinho.getRestantes() + " lugares no carrinho\n\r");
                    } else {
